...
const Number = () => {
    return (
        <div className='mx-auto py-32 px-5 lg:px-20 line-bg'>
            ...
            <div className='mx-auto pt-16 px-5 lg:px-36 flex flex-wrap flex-row md:justify-between justify-center items-center'>
