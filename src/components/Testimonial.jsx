...
const Testimonial = () => {
    ...
    const data = [
        ...
        },
        {
            ...
            position: 'CTO',
            para: `I just can't get enough of Flex. I want to get a T-Shirt with Flex on it so I can show it off to everyone. I will recommend you to my colleagues.`
        },
        {
            id: 3,
            name: 'Elen Benitez',
    ...
    return (
        <>
            ...
            <div className='bg-gray-900 w-full px-10 md:px-20 testimonial py-10'>
                <h1 className='font-bold text-4xl text-center text-gray-100'>Testimonial from Flex app users</h1>
                <p className='max-w-2xl text-center font-medium mx-auto mt-2 text-gray-600 mb-6'>With Flex, you can build websites without writing code.</p>
                <Slider {...settings}>
                    {
